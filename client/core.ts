...
export class AdmirMessagingCore extends MeteorComponent implements OnInit {
  ...
  protected get inRegistered(): boolean {
    ...
    protected get inBranchManager(): boolean {
    return Roles.userIsInRole(Meteor.userId(), ['Branch Manager'], 'default-group');
  }
    protected get inAreaManager(): boolean {
    return Roles.userIsInRole(Meteor.userId(), ['Area Manager'], 'default-group');
  }
